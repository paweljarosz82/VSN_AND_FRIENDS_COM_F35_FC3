...
local centerline 	= {
	{ CLSID = "{INV-SMOKE-RED}"		,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.5, 0.08 ,0 }}, --Smoke - red
	{ CLSID = "{INV-SMOKE-GREEN}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.5, 0.08 ,0 }}, --Smoke - green
	{ CLSID = "{INV-SMOKE-BLUE}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.5, 0.08 ,0 }}, --Smoke - blue
	{ CLSID = "{INV-SMOKE-WHITE}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.5, 0.08 ,0 }}, --Smoke - white
	{ CLSID = "{INV-SMOKE-YELLOW}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.5, 0.08 ,0 }}, --Smoke - yellow	
	{ CLSID = "{INV-SMOKE-ORANGE}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.5, 0.08 ,0 }}, --Smoke - orange
	--{ CLSID = "{VSN_Smoke_Black}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.5, 0.08 ,0 }}, --Smoke - black
...
VSN_F35C_AG =  {
		...
		Name 			= 'VSN_F35C_AG',--AG
		DisplayName		= _('F-35C Lightning AG'),--AG
        Picture 		= "VSN_F35C.png",
        Rate 			= "50",
        Shape			= "VSN_F35C_AG",--AG	
	...
	{
		{
			...
			desrt    	= 'VSN_F35C-oblomok'; -- Name of destroyed object file name
			fire  	 	= { 300, 2}; 			-- Fire on the ground after destoyed: 300sec 2m
			username	= 'VSN_F35C_AG';--AG
			index       =  WSTYPE_PLACEHOLDER;
			classname   = "lLandPlane";
			positioning = "BYNORMAL";
		},
		{
			name  		= "VSN_F35C-oblomok";
			file  		= "VSN_F35C-oblomok";
			fire  		= { 240, 2};
		},
	},
	...
	Categories= {"{78EFB7A2-FD52-4b57-A6A6-3BF0E1D6555F}", "Interceptor",},
		...
		crew_members = 
		{
			[1] = 
			{
				...
				pilot_name			= 	19,
				drop_canopy_name	=	"VSN_F35C-fonar";
				pos = 	{6.277,	1.198,	0},
			}, -- end of [1]
		}, -- end of crew_members
		...
		effects_presets = {
			{effect = "OVERWING_VAPOR", file = current_mod_path.."/Effects/VSN_F35C_overwingVapor.lua"},
		},
...
--  	aircraft_task(AntishipStrike),
	...
	DamageParts = 
	{  
		[1] = "VSN_F35C-oblomok-wing-r", -- wing R
		[2] = "VSN_F35C-oblomok-wing-l", -- wing L
--		[3] = "VSN_F35C-oblomok-noise", -- nose
--		[4] = "VSN_F35C-oblomok-tail-r", -- tail
--		[5] = "VSN_F35C-oblomok-tail-l", -- tail
	},
