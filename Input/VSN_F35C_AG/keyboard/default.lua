...
{combos = {{key = 'Q', reformers = {'LAlt'}}}, down = iCommandPlane_HOTAS_NoseWheelSteeringButtonOff, name = _('Nose Wheel Steering'), category = _('Systems')},
...
-- Modes
--{combos = {{key = '1'}}, iCommandPlaneModeNAV, name = _('(1) Navigation Modes'),	category = _('Modes')},
...
{combos = {{key = 'I'}}, down = iCommandPlaneRadarOnOff, name = _('Radar/ELINT On/Off'), category = _('Sensors')},
...
{combos = {{key = 'U'}}, down = iCommandPlaneRightMFD_OSB6_Off, name = _('Launch Bar Toggle'), category = _('Carrier Operations')}, -- command Nr.1012
{combos = {{key = 'U', reformers = {'LCtrl'}}}, down = iCommandPlaneShipTakeOff, name = _('Catapult Hook-Up'),	category = _('Carrier Operations')}, -- command Nr. 120
