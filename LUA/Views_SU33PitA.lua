ViewSettings = {
	Cockpit = {
	[1] = {-- player slot 1
		CockpitLocalPoint      = {6.301, 0.780, 0.0},--Cockpit nach = vorne,hoch
		...
		limits_6DOF            = {x = {0.080000,0.400000},y ={-0.300000,0.100000},z = {-0.250000,0.250000},roll = 90.000000},--Bewegen = hinten vorne,oben unten,links rechts
