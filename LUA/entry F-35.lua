...
F35.old 				= 6
dofile(current_mod_path.."/LUA/Views_F35PitA.lua")
make_view_settings('VSN_F35A', ViewSettings, SnapViews)
make_flyable('VSN_F35A',current_mod_path..'/Cockpit/KneeboardRight/',F35, current_mod_path..'/comm.lua')--EFM
-------------------------------------------------------------------------------------
local cfg_path = current_mod_path ..  "/FM/F35/config.lua"
dofile(cfg_path)
F35[1] 				= self_ID
...
F35.config_path 		= cfg_path
F35.old 				= 6
dofile(current_mod_path.."/LUA/Views_F35PitB.lua")
make_view_settings('VSN_F35B', ViewSettings, SnapViews)
make_flyable('VSN_F35B',current_mod_path..'/Cockpit/KneeboardRight/',F35, current_mod_path..'/Comm.lua')--AFM
--make_flyable('VSN_F35B',current_mod_path..'/Cockpit/Scripts/',F35, current_mod_path..'/Comm.lua')--AFM
-------------------------------------------------------------------------------------
local cfg_path = current_mod_path ..  "/FM/F35/config.lua"
dofile(cfg_path)
F35[1] 				= self_ID
...
make_flyable('VSN_F35B_AG',current_mod_path..'/Cockpit/KneeboardRight/',F35, current_mod_path..'/Comm.lua')--AFM
--make_flyable('VSN_F35B_AG',current_mod_path..'/Cockpit/Scripts/',F35, current_mod_path..'/Comm.lua')--AFM
-------------------------------------------------------------------------------------
local cfg_path = current_mod_path ..  "/FM/F35/config.lua"
dofile(cfg_path)
F35[1] 				= self_ID
...
F35.config_path 		= cfg_path
F35.old 				= 6
dofile(current_mod_path.."/LUA/Views_F35PitC.lua")
make_view_settings('VSN_F35C', ViewSettings, SnapViews)
make_flyable('VSN_F35C',current_mod_path..'/Cockpit/KneeboardRight/',F35, current_mod_path..'/Comm.lua')--AFM
--make_flyable('VSN_F35C',current_mod_path..'/Cockpit/Scripts_35C/',F35, current_mod_path..'/Comm.lua')--AFM
-------------------------------------------------------------------------------------
local cfg_path = current_mod_path ..  "/FM/F35/config.lua"
dofile(cfg_path)
F35[1] 				= self_ID
...
make_flyable('VSN_F35C_AG',current_mod_path..'/Cockpit/KneeboardRight/',F35, current_mod_path..'/Comm.lua')--AFM
--make_flyable('VSN_F35C_AG',current_mod_path..'/Cockpit/Scripts_35C/',F35, current_mod_path..'/Comm.lua')--AFM
-------------------------------------------------------------------------------------
