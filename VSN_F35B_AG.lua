...
local centerline 	= {
	{ CLSID = "{INV-SMOKE-RED}"		,arg_value = 1,connector = "disable",attach_point_position = {-3.0, 0.15 ,0 }}, --Smoke - red
	{ CLSID = "{INV-SMOKE-GREEN}"	,arg_value = 1,connector = "disable",attach_point_position = {-3.0, 0.15 ,0 }}, --Smoke - green
	{ CLSID = "{INV-SMOKE-BLUE}"	,arg_value = 1,connector = "disable",attach_point_position = {-3.0, 0.15 ,0 }}, --Smoke - blue
	{ CLSID = "{INV-SMOKE-WHITE}"	,arg_value = 1,connector = "disable",attach_point_position = {-3.0, 0.15 ,0 }}, --Smoke - white
	{ CLSID = "{INV-SMOKE-YELLOW}"	,arg_value = 1,connector = "disable",attach_point_position = {-3.0, 0.15 ,0 }}, --Smoke - yellow	
	{ CLSID = "{INV-SMOKE-ORANGE}"	,arg_value = 1,connector = "disable",attach_point_position = {-3.0, 0.15 ,0 }}, --Smoke - orange
	--{ CLSID = "{VSN_Smoke_Black}"	,arg_value = 1,connector = "disable",attach_point_position = {-3.0, 0.15 ,0 }}, --Smoke - black
	{ CLSID = "{VSN_F35_Gunpod}" 	,arg_value = 0},--F35_Gunpod
	{ CLSID = "<CLEAN>"				,arg_value = 1.0}, --REMOVE Gunpod	
	--{ CLSID = "{GAU_12_Equalizer}",		arg_value = 1.0 },
	--{ CLSID = "{GAU_12_Equalizer_AP}",	arg_value = 1.0 },
	--{ CLSID = "{GAU_12_Equalizer_HE}",	arg_value = 1.0 },
}

local ECM 			= { --AG
	{ CLSID = "{44EE8698-89F9-48EE-AF36-5FD31896A82F}",arg_value = 1,connector = "disable"},--L005 Sorbtsiya ECM pod(left)
	{ CLSID = "{INV-SMOKE-RED}"		,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - red
	{ CLSID = "{INV-SMOKE-GREEN}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - green
	{ CLSID = "{INV-SMOKE-BLUE}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - blue
	{ CLSID = "{INV-SMOKE-WHITE}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - white
	{ CLSID = "{INV-SMOKE-YELLOW}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - yellow	
	{ CLSID = "{INV-SMOKE-ORANGE}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - orange
	--{ CLSID = "{VSN_Smoke_Black}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - black
}

local ELINT			= { --AG
	{ CLSID = "{0519A264-0AB6-11d6-9193-00A0249B6F00}",arg_value = 1,connector = "disable"},-- ELINT
	{ CLSID = "{INV-SMOKE-RED}"		,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - red
	{ CLSID = "{INV-SMOKE-GREEN}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - green
	{ CLSID = "{INV-SMOKE-BLUE}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - blue
	{ CLSID = "{INV-SMOKE-WHITE}"	,arg_value = 1,connector = "AFTERBURN_001",attach_point_position = {1.2, 0.08 ,0 }}, --Smoke - white
...
VSN_F35B_AG =  {
		...
		Name 			= 'VSN_F35B_AG',--AG
		DisplayName		= _('F-35B Lightning AG'),--AG
        Picture 		= "VSN_F35B.png",
        Rate 			= "50",
        Shape			= "VSN_F35B_AG",--AG	
	...
	{
		{
			...
			desrt    	= 'VSN_F35B-oblomok'; -- Name of destroyed object file name
			fire  	 	= { 300, 2}; 			-- Fire on the ground after destoyed: 300sec 2m
			username	= 'VSN_F35B_AG';--AG
			index       =  WSTYPE_PLACEHOLDER;
			classname   = "lLandPlane";
			positioning = "BYNORMAL";
		},
		{
			name  		= "VSN_F35B-oblomok";
			file  		= "VSN_F35B-oblomok";
			fire  		= { 240, 2};
		},
	},
	...
	Categories= {"{78EFB7A2-FD52-4b57-A6A6-3BF0E1D6555F}", "Interceptor",},
		...
		crew_members = 
		{
			[1] = 
			{
				...
				pilot_name			= 	19,
				drop_canopy_name	=	"VSN_F35B-fonar";
				pos = 	{6.277,	1.198,	0},
			}, -- end of [1]
		}, -- end of crew_members
		...
		effects_presets = {
			{effect = "OVERWING_VAPOR", file = current_mod_path.."/Effects/VSN_F35B_overwingVapor.lua"},
		},
...
--  	aircraft_task(AntishipStrike),
	...
	DamageParts = 
	{  
		[1] = "VSN_F35B-oblomok-wing-r", -- wing R
		[2] = "VSN_F35B-oblomok-wing-l", -- wing L
--		[3] = "VSN_F35B-oblomok-noise", -- nose
--		[4] = "VSN_F35B-oblomok-tail-r", -- tail
--		[5] = "VSN_F35B-oblomok-tail-l", -- tail
	},
